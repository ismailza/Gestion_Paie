          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="home-tab">
                ...
                <form method="post" action="../scripts/employe.inc.php" class="row g-3 needs-validation" id="msform" enctype="multipart/form-data" novalidate>
                  ...
                  <div class="card mt-3">
                    ...
                    <div class="card-footer">
                      ...
                      <button class="action submit btn btn-sm btn-outline-success float-end" name="addEmploye" style="display: none">Ajouter</button>
                    </div>
                  </div>
