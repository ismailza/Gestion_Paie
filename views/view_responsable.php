                                        ...
                                        <div class="col-md-3 border-right">
                                            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                                <img class="rounded-circle mt-5" width="150px"
                                                    src="images/profile/IMG_20210102_203408_124.jpg">
                                                <span
                                                    class="font-weight-bold"><?php echo $user['nom'] . " " . $user['prenom']; ?></span>
                                                <span class="text-black-50"><?php echo $user['email']; ?></span>
                                                <span class="text-black-50"><?php echo $user['titre']; ?></span>
                                            </div>
                                        </div>
                                            ...
                                            <div class="p-3 py-5">
                                                ...
                                                <form action="view_responsable" method="post">
                                                    <input type="hidden" name="id"
                                                        value="<?php echo $user['idEmploye']; ?>">

                                                    <div class="row mt-2">
                                                        <div class="col-md-6">
                                                            <label class="labels">Nom</label>
                                                            <input type="text" class="form-control" name="nom"
                                                                value="<?php echo $user['nom']; ?>" disabled>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="labels">Prénom</label>
                                                            <input type="text" class="form-control" name="prenom"
                                                                value="<?php echo $user['prenom']; ?>" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row mt-2">
                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" name="tel"
                                                                value="<?php echo $user['phone']; ?>" disabled>
                                                        </div>
                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" name="adress"
                                                                value="<?php echo $user['adresse']; ?>" disabled>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="labels">Ville</label>
                                                            <input type="text" class="form-control" name="ville"
                                                                value="<?php echo $user['ville']; ?>" disabled>
                                                        </div>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" name="situation" class="form-control"
                                                                value="<?php echo $user['situationF']; ?>" disabled>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="labels">Nombre d'enfants</label>
                                                            <input type="text" name="nbEnfant" class="form-control"
                                                                value="<?php echo $user['nbEnfants']; ?>" disabled>
                                                        </div>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" name="cnss" class="form-control"
                                                                value="<?php echo $user['numCNSS']; ?>" disabled>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="labels">AMO</label>
                                                            <input type="text" name="amo" class="form-control"
                                                                value="<?php echo $user['numAMO']; ?>" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row mt-2">
                                                        <div class="col-md-6">
                                                            <label class="labels">CIMR</label>
                                                            <input type="text" name="cimr" class="form-control"
                                                                value="<?php echo $user['numCIMR']; ?>" disabled>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="labels">IGR</label>
                                                            <input type="text" name="igr" class="form-control"
                                                                value="<?php echo $user['numIGR']; ?>" disabled>
                                                        </div>
                                                    </div>

                                                    <div class="mt-2 text-center">
                                                        <button class="btn btn-info profile-button" id="btn1"
                                                            type="button" onclick="Update()">Modifier</button>
                                                    </div>


                                                    <button class="btn btn-info profile-button" id="btn2"
